...
class Estado extends Model
{
    ...
    public function obtenerEstados($buscar='', $pagina=1)
    {
        $limite=7;        
    ...
    {
        $sql = "select id,estado from estados p where p.eliminado =0 and activo=1 order by nombre asc";
        $estados = DB::select($sql);
        return $estados;
    }
