            ...
            <div class="col-lg-12">
                <div class="ibox ">
                    ...
                    <div class="ibox-content">
                        <form action="{{route("estadofacturas.insertar")}}" method="post">
                            @csrf
                            ...
                            <div class="form-group row">
                                <div class="col-sm-4 col-sm-offset-2">
                                    ...
                                    <button class="btn btn-danger " type="button" onclick="location.href='{{route('estadofacturas.index')}}'">Cancelar</button>
