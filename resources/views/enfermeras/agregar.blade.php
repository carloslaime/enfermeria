            ...
            <div class="col-lg-12">
                <div class="ibox ">
                    ...
                    <div class="ibox-content">
                        <form action="{{route("enfermeras.insertar")}}" method="post">
                            @csrf
                            ...
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Especialidad:<i class="text-danger">*</i></label>
                                <div class="col-sm-10">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-control" name="estado_id"  id="estado_id">
                                        ...
                                        @foreach ($estadoenfermeras as $estadoenfermera)
                                            <option value="{{$estadoenfermera->id}}" >{{$estadoenfermera->estado}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
