        ...
        <div class="col-lg-12">
            <div class="ibox ">
                <div class="ibox-title">
                    <a class="btn btn-primary" href="{{route('modalidades.agregar')}}">Agregar</a>
                    <div class="ibox-tools"><a class="collapse-link"><i class="fa fa-chevron-up"></i></a></div>
                </div>
                <div class="ibox-content">
                    <form name="formBuscar" action="{{route("modalidades.index")}}" method="get">
                        <div class="row">
                        ...
                        <tbody>
                            @foreach($modalidades as $modalidad)
                                <tr>
                                    ...
                                    <td>{{fecha_latina($modalidad->created_at) }}</td>
                                    <td>{{fecha_latina($modalidad->updated_at) }}</td>
                                    <td data-texto="{{$modalidad->tipo}}">
                                        <a href="{{route('modalidades.mostrar',$modalidad->id)}}" title="Mostrar"><img width="17px" src="{{asset('img/iconos/mostrar.png')}}" alt="Mostrar"></a>
                                        <a href="{{route('modalidades.modificar',$modalidad->id)}}" title="Modificar"><img width="17px" src="{{asset('img/iconos/modificar.png')}}" alt="Modificar"></a>
                                        <a data-ruta="{{route('modalidades.eliminar',$modalidad->id)}}" class="btn-eliminar" title="Eliminar"><img width="17px" src="{{asset('img/iconos/eliminar.png')}}" alt="Eliminar"></a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
