...
@section('content')
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-12">
            <h2>Agregar Estado Enfermeras</h2>
        </div>
    </div>
            ...
            <div class="col-lg-12">
                <div class="ibox ">
                    ...
                    <div class="ibox-content">
                        <form action="{{route("estadoenfermeras.insertar")}}" method="post">
                            @csrf
                            ...
                            <div class="form-group row">
                                <div class="col-sm-4 col-sm-offset-2">
                                    ...
                                    <button class="btn btn-danger " type="button" onclick="location.href='{{route('estadoenfermeras.index')}}'">Cancelar</button>
